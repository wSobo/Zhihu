package com.example.sobo.zhihu.util;
...
public class DBUtils {
    ...
    private DBUtils(Context context) {
        mSQLiteDatabase = new DBHelper(context, "IsRead.db").getWritableDatabase();
    }
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, "zhihu"));
        }
